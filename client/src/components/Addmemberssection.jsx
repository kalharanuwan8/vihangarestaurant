...
import { ShieldCheckIcon, UserIcon, ArrowUturnLeftIcon } from '@heroicons/react/24/outline'; // Better icons

// Reusable Input Component with properly aligned icon
const PasswordInput = ({ id, label, value, onChange, showPassword, onToggleVisibility }) => (
  <div className="space-y-1">
    ...
    <div className="relative">
      ...
      >
        {showPassword ? (
          <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13.875 18.825A10.05 10.05 0 0112 19c-4.478 0-8.268-2.943-9.542-7a10.05 10.05 0 012.392-3.432M9.88 9.88a3 3 0 104.242 4.242M15 12a3 3 0 01-3 3M3 3l18 18" /></svg>
        ) : (
...
const AddMemberssection = () => {
  ...
  const handleSubmit = (e) => {
    ...
    alert(`Adding ${selectedUserType} user:\nEmail: ${email}`);
